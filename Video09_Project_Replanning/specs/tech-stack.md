...
| CSS | Plain CSS + CSS custom properties | No build step required; responsive design by default; Steve gets a modern, attractive result |
| Testing | **Vitest** | Fast, TypeScript-native validation for core logic |
