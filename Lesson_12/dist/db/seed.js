...
export function seed(db) {
    ...
    const insertLink = db.prepare("INSERT OR IGNORE INTO agent_ailments (agent_id, ailment_id) VALUES (?, ?)");
    ...
    const insertAppointment = db.prepare("INSERT OR IGNORE INTO appointments (id, agent_id, therapist_name, scheduled_at, status) VALUES (@id, @agent_id, @therapist_name, @scheduled_at, @status)");
    ...
    const insertFeedback = db.prepare("INSERT OR IGNORE INTO feedback (id, name, email, message, rating) VALUES (@id, @name, @email, @message, @rating)");
